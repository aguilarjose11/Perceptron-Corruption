...
#SBATCH --job-name=spect_non_corr                                                      
...
# Usually, it is SMOTE_$EXP_NUMBER
INDEXLABEL=_$EXP_NUMBER
...
# bnakruptcy: 0.7 | spambase: 0.4 | SPECT: 0.27 | iris: 0.2 | skin: 0.2
TESTFRACT=0.2

# add --smote to use SMOTE
python corruption_experiment3.py  --save_model --experiment $EXPERIMENT --bias -t $TESTFRACT -b $BUCKETS -r $NRUNS --eta $ETA --max_iter $MAXITER --w_init -1 1 -v --result_root $RESROOT --index $INDEXLABEL --patience $PATIENCE
