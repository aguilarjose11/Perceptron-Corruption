...
INDEXLABEL=SPECT2_SMOTE_$EXP_NUMBER
...
python corruption_experiment2.py --smote --save_model --experiment $EXPERIMENT --bias -t $TESTFRACT -b $BUCKETS -r $NRUNS --eta $ETA --max_iter $MAXITER --w_init -1 1 -v --result_root $RESROOT --index $INDEXLABEL --patience $PATIENCE
